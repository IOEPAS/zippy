...
ifndef PYTHON3
    $(error Python3.6 is not available on your system, please install python3.6)
endif
...
lint:
	...
	$(PYTHON3) -m pylint src/pipeline src/server src/utils tests scripts
...
ifndef TOPIC
	...
	$(PYTHON3) scripts/utils.py create_nb $(TOPIC)
endif
